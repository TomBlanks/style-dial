...
|---|---|---|---|
| 2026-09-24 | §3 | The repo root is `styledial/`, not `style-dial/`. | It's the existing repo. |
...
| §6.4, §6.10 | There's no title row. The top row holds the version tabs, a **+** button and the minimise button. The panel's accessible name is still "Style Dial". | Saves a row and reduces clutter. |
